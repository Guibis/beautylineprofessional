    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm shadow-sm">
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          <a href="#javascript:void(0)" className="text-stone-600 hover:text-purple-400 transition-colors font-medium">Chi Siamo</a>
          ...
          <a href="#javascript:void(0)" className="px-6 py-2.5 bg-purple-600 text-white rounded-full font-medium hover:bg-purple-700 transition-colors">Registrazione</a>
        </div>
        ...
        <div className="md:hidden" ref={menuRef}>
          ...
          <div className="md:hidden bg-white border-t border-stone-100 shadow-lg absolute top-full left-0 right-0 py-4 px-6 flex flex-col gap-4">
            <a href="#javascript:void(0)" className="text-stone-600 hover:text-purple-600 font-medium">Chi Siamo</a>
            ...
            <a href="#javascript:void(0)" className="px-6 py-2.5 bg-purple-600 text-white rounded-full font-medium hover:bg-purple-700 transition-colors text-center w-full">Registrazione</a>
          </div>
        )}
        </div>
      </div>  
